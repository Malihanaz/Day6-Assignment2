...
class SalaryCalculationSystem
{
    static void Main()
    {
        ...
        double monthlySalary = CalculateSalary(workingHours, numWorkingDays, projectHandles, extras);
    ...
    {
        // Assuming hourly rate is $100, projectHandles rate is $3000, and extras rate is $2000
